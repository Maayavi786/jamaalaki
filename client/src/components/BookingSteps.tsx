...
const BookingSteps = () => {
  ...
  return (
    <div className="py-16 bg-gradient-to-r from-secondary/30 to-accent/30 dark:from-neutral-800/30 dark:to-neutral-800/20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step) => (
            <div key={step.number} className="bg-background dark:bg-neutral-800/20 rounded-xl p-6 relative">
              <div className="absolute -top-5 -right-5 w-12 h-12 rounded-full bg-primary flex items-center justify-center text-white font-bold text-lg shadow-lg">
                {step.number}
              </div>
